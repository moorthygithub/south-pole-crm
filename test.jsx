                ...
                <div className="text-[12px]">
                  <table className="w-full border-collapse table-fixed border-b border-black">
                    <thead>
                      <tr className="border-b border-black">
                        <th className="border-r border-black px-1 text-center w-[4%]">
                          S.No
                        </th>
                        <th className="border-r border-black px-1 text-center w-[10%]">
                          Marks & Nos
                        </th>
                        <th className="border-r border-black px-2 text-left w-[30%]">
                          Description
                        </th>
                        <th className="border-r border-black px-1 text-center w-[6%]">
                          UOM
                        </th>
                        <th className="border-r border-black px-1 text-center w-[8%]">
                          Quantity
                        </th>
                        <th className="border-r border-black px-1 text-center w-[10%]">
                          Net Weight
                        ...
                        <th className="px-2 text-right w-[12%]">Amount</th>
                      </tr>
                    </thead>
                  ...
                  <table className="w-full border-collapse border-b border-black text-[12px]">
                    <tbody>
                      <tr className="font-semibold">
                        <td
                          colSpan={3}
                          className="border-r border-black px-2 py-1 align-top"
                        >
                          Amount (In Words)
                        </td>

                        <td colSpan={8} className="px-2 py-1 text-left">
                  ...
                  <table className="w-full text-[11px]">
                    <tbody>
                      {/* Header */}
                      <tr className="font-semibold">
                        <td colSpan={9} className="px-2 py-1 text-left">
                          GST Data for India
                        </td>
                      ...
                      <tr>
                        <td
                          colSpan={3}
                          className="border-y border-black px-2 py-1 w-[14%]"
                        >
                          Taxable Value $
                        </td>
                        ...
                        <td
                          colSpan={1}
                          className="border-y border-black px-2 py-1 text-right"
                        >
                          $33,990.00
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td
                          colSpan={8}
                          className="border-y border-black px-2 py-2 text-[10px] italic"
                        >
                        ...
                        <td
                          colSpan={3}
                          className="border-y border-black px-2 py-2 text-right align-bottom"
                        >
