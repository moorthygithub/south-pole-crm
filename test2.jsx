...
// import useMasterQueries from "@/hooks/useMasterQueries";
// import { useQueryClient } from "@tanstack/react-query";
// import { FileText, Package, Trash2, Weight, Plus } from "lucide-react";
// import moment from "moment";
// import { useEffect, useState } from "react";
// import { useNavigate, useParams, useSearchParams } from "react-router-dom";
// import { toast } from "sonner";
...
//       // If edit mode and subs1 exists, populate cartons from subs1
//       if (isEdit && data.subs1 && data.subs1.length > 0) {
//         // Group subs1 by carton_no
//         const cartonMap = {};
...
//           // Find the matching invoice sub item
...
//   const filteredAvailableItems = availableItems
//     .map((item) => {
//       const packed = packedQtyMap[item.invoiceSub_id] || 0;
//       const remaining = Number(item.invoiceSub_qnty) - packed;
//       return remaining > 0 ? { ...item, remainingQty: remaining } : null;
//     })
//     .filter(Boolean)
...
//       <PageHeader
//         icon={FileText}
//         title={`Invoice Packing ${isEdit ? "(Edit Mode)" : ""}`}
//         rightContent={
...
//                   <div
//                     key={item.row_id}
//                     className="bg-card border rounded-lg p-3 hover:shadow-md transition-all duration-200 hover:border-primary"
//                   >
...
//                   placeholder="Box Size"
//                 />
//                 <Button onClick={addCarton} className="w-full">
...
//                             readOnly
//                             placeholder="0.00"
//                             className="h-9 bg-accent text-accent-foreground font-medium"
//                           />
//                         </div>
//                       </div>
